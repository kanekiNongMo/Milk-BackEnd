...
public class SessionArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
        ...
        // 获取cookie
        String requestParameterToken = request.getParameter("JSESSIONID");
        log.info("requestParameterToken:" + requestParameterToken);
        // 获取cookie
        String cookiesToken = getParameterCookies(request, "JSESSIONID");
        log.info("cookiesToken:" + cookiesToken);
